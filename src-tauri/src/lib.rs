...
pub fn run() {
  ...
  tauri::Builder::default()
    ...
    .invoke_handler(tauri::generate_handler![db::init_db, db::run_migrations_cmd, db::get_logs_dir, db::save_champion_image, db::add_champion, db::get_champion_by_code, db::update_champion, db::delete_champion, db::delete_champion_by_code, db::list_champions, db::get_image_data, db::set_combos, db::set_champion_notes, db::list_tags, db::create_or_get_tag, db::rename_champion_note, db::duplicate_champion_note, db::delete_champion_note])
